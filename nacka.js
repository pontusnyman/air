function initMap(){
	...
	var nackaforum = {
		info: '<strong>Nacka Forum 1</strong><br>\
                <p>Cykelvägen vid Värmdövägen</p>\<a href="https://maps.apple.com/?daddr=59.308620,18.165088">Hitta hit</a>',
		lat: 59.308620,
		long: 18.165088
	};

	var kihlsgard = {
		info: '<strong>Busshållplats vid Kilhsgård</strong><br>\
                <p>Vid Värmdövägen/Velamsundsvägen</p>\<a href="https://maps.apple.com/?daddr=59.332489,18.313629">Hitta hit</a>',
		lat: 59.332489,
		long: 18.313629
	};
	...
	var locations = [
		...
		[korsbergsvagen.info, korsbergsvagen.lat, korsbergsvagen.long, 4],
		[nackaforum.info, nackaforum,lat, nackaforum.long, 5],
		[kihlsgard.info, kihlsgard.lat, kihlsgard.long, 6]			
	]
