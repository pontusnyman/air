function initMap(){
	...
	var lundavagen = {
		info: '<strong>Lundavägen</strong><br>\
                <p>Vid cykelstället mellan Burlöv Center och busshållplatsen.</p>\<a href="https://maps.apple.com/?daddr=55.638967,13.085736">Hitta hit</a>',
		lat: 55.638967,   
		long: 13.085736
	};
	...
	//Arlövs Array
	var locations = [
		[lundavagen.info, lundavagen.lat, lundavagen.long, 0],		
	]
	
	var map = new google.maps.Map(document.getElementById('map'), {
	zoom: 15,
	//center: new google.maps.LatLng(55.637905, 13.083517),
    ...
    function showError(error) {
      map.setCenter(new google.maps.LatLng(55.637905, 13.083517));
    }
}
